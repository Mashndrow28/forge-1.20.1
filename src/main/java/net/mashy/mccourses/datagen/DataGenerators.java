...
public class DataGenerators {
    ...
    public static void gatherData(GatherDataEvent event){
        ...
        generator.addProvider(event.includeServer(),
                new ModItemTagGenerator(packOutput, lookupProvider, blockTagsProvider.contentsGetter(), existingFileHelper));
        ...
        generator.addProvider(event.includeClient(), new ModPoiTagsProvider(packOutput, lookupProvider, existingFileHelper));
