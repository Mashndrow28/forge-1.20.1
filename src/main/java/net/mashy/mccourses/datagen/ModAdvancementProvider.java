    ...
    public void generate(HolderLookup.Provider registries, Consumer<Advancement> saver, ExistingFileHelper existingFileHelper) {
        Advancement rootAdvancement = Advancement.Builder.advancement()
                .display(new DisplayInfo(new ItemStack(ModItems.ALEXANDRITE.get()),
                        ...
                        new ResourceLocation(MCCourseMod.MOD_ID, "textures/block/alexandrite_ore.png"),
                        FrameType.TASK,
                        true,true,false))
                .addCriterion("has_alexandrite", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.ALEXANDRITE.get()))
                .save(saver, new ResourceLocation(MCCourseMod.MOD_ID,"mccourses"),existingFileHelper);
        ...
        Advancement metalDetector = Advancement.Builder.advancement()
                .display(new DisplayInfo(new ItemStack(ModItems.METAL_DETECTOR.get()),
                        Component.literal("Detector Metal"), Component.literal("Batteries not included! (cry about it)"),
                        null,
                        FrameType.TASK,
                        true,true,false))
